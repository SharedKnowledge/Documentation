...
\\Die dafür teils von der Chatfunktionalität weitergenutzte und teils neu entwickelte Oberfläche wird nun wieder anhand eines kleinen Beispiels beschrieben. Das Gerät \textit{Nexus5x} möchte sich mit all enGeräten in er Umgebung über das Thema HTW-Motorsport unterhalten. Zunächst werden alle begrüßt, da bisher unbekannt ist, welches Gerät sich in Reichweite befindet.\newline\newline
\hspace*{0cm}
