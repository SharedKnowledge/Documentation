...
\begin{itemize}
	...
	\item Einen Informationsraum (Information Space), der die semantische Beschreibung des Nachrichteninhalts ist. Er besteht aus den in Kapitel zwei beschriebenen sieben Dimensionen mit den dazugehörigen Semantischen Netzen
	\item Der eigentliche Nachrichteninhalt (Info Content)	
\end{itemize}
Der in Abbildung 2 dargestellte Bereich \textit{Info Meta Data} befindet sich daher sich wie oben beschrieben im Header und nicht im Knowledge.
