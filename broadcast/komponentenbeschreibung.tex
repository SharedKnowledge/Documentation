...
\begin{figure}[H]
	\centering
	\hspace*{1cm}
	\makebox[\linewidth][c]{\includegraphics[width=0.6\linewidth]{general/BroadcastStruktur1.png}}
...
\end{itemize}
Die Broadcast-Komponente benutzt zum Versenden von Nachrichten WiFi-Direct, Bluetooth (BT), Radar und den Semantischen Filter:
\begin{figure}[H]
	\centering
	\hspace*{1cm}
